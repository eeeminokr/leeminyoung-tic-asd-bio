...
public class SurveyAsdBdi02VO extends KoriginCommonVO{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -7910154076427495864L;
	...
	private String score; // 마지막 a23
	
	private String bdiExecDate;
	private String a1;
	private String a2;
	private String a3;
	private String a4;
	...
	public String getBdiExecDate() {
		return bdiExecDate;
	}
	public void setBdiExecDate(String bdiExecDate) {
		this.bdiExecDate = bdiExecDate;
	}
	public String getA1() {
		return a1;
	}
