...
public class SurveyAsdCc3qaVO extends KoriginCommonVO{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 4061067337095192997L;
	...
	public String getCc3qaExecDate() {
		return cc3qaExecDate;
	}
	public void setCc3qaExecDate(String cc3qaExecDate) {
		this.cc3qaExecDate = cc3qaExecDate;
	}
	public String getA1() {
		return a1;
	}
