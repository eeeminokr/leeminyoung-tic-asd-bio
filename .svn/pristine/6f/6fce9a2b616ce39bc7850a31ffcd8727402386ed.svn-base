...
<script type="text/javascript" src="${contextPath}/js/medical/imaging/imagingListAo.js"></script>
	                ...
	                <ul>
	                    ...
	                    <li>
	                        ...
	                        <div class="cont check_right">
	                            ...
	                            <label><input type="checkbox" name="swi" /><span>SWI</span></label>
	                        </div>
	                    </li>
	                </ul>
	                <div class="btm">
