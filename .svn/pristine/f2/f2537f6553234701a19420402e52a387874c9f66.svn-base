...
public class SurveyAsdScqVO extends KoriginCommonVO{
	/**
	 * SCQ(current, lifetime)
	 */
	...
	public String getScqExecDate() {
		return scqExecDate;
	}
	public void setScqExecDate(String scqExecDate) {
		this.scqExecDate = scqExecDate;
	}
	...
	public String getlTotalScore() {
		return lTotalScore;
	}
	public void setlTotalScore(String lTotalScore) {
