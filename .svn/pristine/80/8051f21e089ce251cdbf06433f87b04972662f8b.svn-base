...
public class SurveyRcmasWriterMapper implements CellWriterMapper<SurveyRcmasVO>{
	@Override
	public void mapHeader(Row row, SurveyRcmasVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyRcmasVO vo) {
		Cell cell = null;
		int i = 0;
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 6, 43));
