...
public class SurveyAsdLsd01WriterMapper implements CellWriterMapper<SurveyAsdLsd01VO>{
	@Override
	public void mapHeader(Row row, SurveyAsdLsd01VO vo) {
		Cell cell = null;
		int i = 0;
		...
		if(rowNum==1) {
			...
			cell.setCellValue("8");
			cell = row.createCell(i++);
			cell.setCellValue("9.1");
			cell = row.createCell(i++);
			cell.setCellValue("9.2");
			cell = row.createCell(i++);
			cell.setCellValue("9.3");
			cell = row.createCell(i++);
			cell.setCellValue("9.4");
			cell = row.createCell(i++);
			cell.setCellValue("9.5");
			cell = row.createCell(i++);
			cell.setCellValue("음식");
			cell = row.createCell(i++);
			cell.setCellValue("동물");
			cell = row.createCell(i++);
			cell.setCellValue("신체부위");
			cell = row.createCell(i++);
			cell.setCellValue("탈 것");
			cell = row.createCell(i++);
			cell.setCellValue("행동");
			cell = row.createCell(i++);
			cell.setCellValue("집안물건");
			cell = row.createCell(i++);
			cell.setCellValue("개인사물");
			cell = row.createCell(i++);
			cell.setCellValue("장소");
			cell = row.createCell(i++);
			cell.setCellValue("수식어");
			cell = row.createCell(i++);
			cell.setCellValue("의류");
			cell = row.createCell(i++);
			cell.setCellValue("기타");
			cell = row.createCell(i++);
			cell.setCellValue("사람");
			
		}
	}
	
	@Override
	public void mapRow(Row row, SurveyAsdLsd01VO vo) {
		Cell cell = null;
		int i = 0;
		cell = row.createCell(i++);
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getLsd01ExecDate());
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 7, 31));
