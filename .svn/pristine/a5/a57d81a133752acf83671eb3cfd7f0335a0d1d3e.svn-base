...
public class SurveyAsdKpsiVO extends KoriginCommonVO{
	/**
	 * 
	 */
	...
	private String a119;
	private String a120;		
	private String a121;		//주의산만/과잉행동 
	private String a122;		//적응              
	private String a123;		//보상              
	private String a124;		//요구              
	private String a125;		//기분              
	private String a126;		//수용              
	private String a127;		//아동 영역         
	private String a128;		//유능감            
	private String a129;		//고립              
	private String a130;		//애착              
	private String a131;		//건강              
	private String a132;		//역할제한          
	private String a133;		//우울              
	private String a134;		//배우자            
	private String a135;		//부모영역          
	private String a136;		//총스트레스        
	private String a137;    	//일상스트레스   
	...
	public String getKpsiExecDate() {
		return kpsiExecDate;
	}
	public void setKpsiExecDate(String kpsiExecDate) {
		this.kpsiExecDate = kpsiExecDate;
	}
