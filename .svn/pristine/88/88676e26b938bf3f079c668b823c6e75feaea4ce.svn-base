...
public class SurveyAsdSrs01WriterMapper implements CellWriterMapper<SurveyAsdSrs01VO>{
	@Override
	public void mapHeader(Row row, SurveyAsdSrs01VO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyAsdSrs01VO vo) {
		Cell cell = null;
		int i = 0;
