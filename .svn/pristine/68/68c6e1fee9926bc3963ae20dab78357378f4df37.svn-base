...
<script type="text/javascript" src="${contextPath}/js/medical/gene/geneList.js"></script>
...
<body>	
	<div id="BodyDiv"> 
		...
		<div class="content_head">
			...
			<h2 class="tit">유전정보</h2>
			<h3 class="tit"></h3>
            <div class="submenu">
            </div>
			<div class="btns">
			<eco:authorize menuId="AO06" authName = "deleteYn">
			<button type="button" onclick="selectDeleteGene();" class="btnsStyle"><img src="${contextPath}/images/img/ico_del.png" alt="" /><span>삭제</span></button>
			</eco:authorize>
				...
				<ul>
                    ...
                    <li class="total_search">
                        <div class="check_right">
                            <label><input type="checkbox" name="analEnvMatt" /><span>WGS</span></label>
