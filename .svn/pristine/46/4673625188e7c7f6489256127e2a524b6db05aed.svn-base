...
public class ClinicianAsdCybocsWriterMapper implements CellWriterMapper<ClinicianAsdCybocsVO>{
	@Override
	public void mapHeader(Row row, ClinicianAsdCybocsVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, ClinicianAsdCybocsVO vo) {
		Cell cell = null;
		int i = 0;
