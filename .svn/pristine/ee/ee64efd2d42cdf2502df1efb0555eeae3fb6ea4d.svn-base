...
<script type="text/javascript" src="${contextPath}/js/medical/survey/surveyList.js"></script>
</head>
<body>	
	<div id="BodyDiv">  
		...
		<form id="searchForm" name="searchForm" onsubmit="doSearch(); return false;">
			...
			<div class="btns">
				<eco:authorize menuId="D001" authName = "deleteYn">
				...
				<eco:authorize menuId="D001" authName = "uploadYn">
				...
				<eco:authorize menuId="D001" authName = "downYn">
				<div class = "dropdown">
                ...
                <ul>
                    ...
                    <li>
                        <div class="check_right" id="check_right">
							...
							<label><input type="checkbox" id="iv4" name="iv4" /><span>4주 간격 면담지</span></label>
                        </div>
                    </li>
                </ul>
                <div class="btm">
