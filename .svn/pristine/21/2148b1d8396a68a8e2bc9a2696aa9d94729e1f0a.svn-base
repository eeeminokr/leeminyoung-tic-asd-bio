...
public class SurveyAsdStaitParentsWriterMapper implements CellWriterMapper<SurveyAsdStaitParentsVO>{
	@Override
	public void mapHeader(Row row, SurveyAsdStaitParentsVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyAsdStaitParentsVO vo) {
		Cell cell = null;
		int i = 0;
		cell = row.createCell(i++);
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getStaitParentsExecDate());
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 7, 34));
