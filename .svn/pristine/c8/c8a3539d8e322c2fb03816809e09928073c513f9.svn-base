...
public class SurveyAsdStaisChildWriterMapper implements CellWriterMapper<SurveyAsdStaisChildVO>{
	@Override
	public void mapHeader(Row row, SurveyAsdStaisChildVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyAsdStaisChildVO vo) {
		Cell cell = null;
		int i = 0;
		cell = row.createCell(i++);
