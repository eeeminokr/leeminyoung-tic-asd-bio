...
public class SurveyAsdArsWriterMapper implements CellWriterMapper<SurveyAsdArsVO>{
	@Override
	public void mapHeader(Row row, SurveyAsdArsVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyAsdArsVO vo) {
		Cell cell = null;
		int i = 0;
		cell = row.createCell(i++);
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getArsExecDate());
