...
public class ClinicianAsdYbocsWriterMapper implements CellWriterMapper<ClinicianAsdYbocsVO>{
	@Override
	public void mapHeader(Row row, ClinicianAsdYbocsVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, ClinicianAsdYbocsVO vo) {
		Cell cell = null;
		int i = 0;
