...
public class SurveyAsdStaitChildWriterMapper implements CellWriterMapper<SurveyAsdStaitChildVO>{
	@Override
	public void mapHeader(Row row, SurveyAsdStaitChildVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyAsdStaitChildVO vo) {
		Cell cell = null;
		int i = 0;
		cell = row.createCell(i++);
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getStaitChildExecDate());
