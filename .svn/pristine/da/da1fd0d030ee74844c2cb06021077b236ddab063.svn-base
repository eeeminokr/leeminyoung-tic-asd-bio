...
public class SurveyAsdBdiParentsVO extends KoriginCommonVO{
	/**
	 * 
	 */
	private static final long serialVersionUID = 234027872893202585L;
	private int rownum;
	...
	private String age;
	private String bdiParentsExecDate;
	private String a1;  
	private String a2;  
	private String a3;  
	private String a4;  
	...
	public String getBdiParentsExecDate() {
		return bdiParentsExecDate;
	}
	public void setBdiParentsExecDate(String bdiParentsExecDate) {
		this.bdiParentsExecDate = bdiParentsExecDate;
	}
