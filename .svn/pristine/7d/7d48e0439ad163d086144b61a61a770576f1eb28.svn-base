...
public class SurveySrsWriterMapper implements CellWriterMapper<SurveySrsVO>{
	@Override
	public void mapHeader(Row row, SurveySrsVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveySrsVO vo) {
		Cell cell = null;
		int i = 0;
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getSrsExecDate());
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 6, 25));
