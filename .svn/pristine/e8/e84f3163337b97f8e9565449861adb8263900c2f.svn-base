...
public class SurveyAsdTrauaVO extends KoriginCommonVO{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -929845470907776162L;
	...
	public String getTrauaExecDate() {
		return trauaExecDate;
	}
	public void setTrauaExecDate(String trauaExecDate) {
		this.trauaExecDate = trauaExecDate;
	}
	public String getA1() {
		return a1;
	}
