...
public class SurveyAsdTraumaWriterMapper implements CellWriterMapper<SurveyAsdTraumaVO>{
	@Override
	public void mapHeader(Row row, SurveyAsdTraumaVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyAsdTraumaVO vo) {
		Cell cell = null;
		int i = 0;
		cell = row.createCell(i++);
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getTraumaExecDate());
