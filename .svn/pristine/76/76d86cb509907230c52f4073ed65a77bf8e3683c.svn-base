...
public class SurveyArsWriterMapper implements CellWriterMapper<SurveyArsVO>{
	@Override
	public void mapHeader(Row row, SurveyArsVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyArsVO vo) {
		Cell cell = null;
		int i = 0;
