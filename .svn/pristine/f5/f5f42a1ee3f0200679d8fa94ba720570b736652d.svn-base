...
public class SurveyAsdSib01WriterMapper implements CellWriterMapper<SurveyAsdSib01VO>{
	@Override
	public void mapHeader(Row row, SurveyAsdSib01VO vo) {
		Cell cell = null;
		int i = 0;
		...
		if(rowNum==1) {
			...
			cell.setCellValue("1");
			cell = row.createCell(i++);
			cell.setCellValue("1 내용");
			cell = row.createCell(i++);
			cell.setCellValue("ㄱ");
			cell = row.createCell(i++);
			cell.setCellValue("ㄴ");
			cell = row.createCell(i++);
			cell.setCellValue("ㄴ 내용");
			cell = row.createCell(i++);
			cell.setCellValue("2");
			cell = row.createCell(i++);
			cell.setCellValue("2 내용");
			cell = row.createCell(i++);
			cell.setCellValue("ㄱ");
			cell = row.createCell(i++);
			cell.setCellValue("ㄴ");
	...
	@Override
	public void mapRow(Row row, SurveyAsdSib01VO vo) {
		Cell cell = null;
		int i = 0;
		cell = row.createCell(i++);
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getSib01ExecDate());
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 7, 46));
