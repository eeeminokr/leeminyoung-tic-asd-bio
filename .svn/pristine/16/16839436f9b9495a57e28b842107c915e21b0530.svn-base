...
public class SurveyAsdPc3q1VO extends KoriginCommonVO{

	/**
	 * 
	 */
	private static final long serialVersionUID = -8301076634302069011L;
	...
	public String getPc3q1ExecDate() {
		return pc3q1ExecDate;
	}
	public void setPc3q1ExecDate(String pc3q1ExecDate) {
		this.pc3q1ExecDate = pc3q1ExecDate;
	}
	public String getA1() {
		return a1;
	}
