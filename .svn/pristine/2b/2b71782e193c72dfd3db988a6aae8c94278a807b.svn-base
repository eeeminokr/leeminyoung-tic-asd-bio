...
public class SurveyStaisYouthWriterMapper implements CellWriterMapper<SurveyStaisYouthVO>{

	@Override
	public void mapHeader(Row row, SurveyStaisYouthVO vo) {
		Cell cell = null;
		int i = 0;
		...
		if(rowNum==1) {
			...
			cell = row.createCell(i++);
			cell.setCellValue("10_역");
			cell = row.createCell(i++);
			cell.setCellValue("11");
			cell = row.createCell(i++);
			cell.setCellValue("11_역");
			cell = row.createCell(i++);
			...
			cell = row.createCell(i++);
			cell.setCellValue("19_역");
			cell = row.createCell(i++);
			cell.setCellValue("20");
			cell = row.createCell(i++);
			cell.setCellValue("20_역");
			cell = row.createCell(i++);
	...
	@Override
	public void mapRow(Row row, SurveyStaisYouthVO vo) {
		Cell cell = null;
		int i = 0;
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getStaisYouthExecDate());
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 6, 36));
	} 
