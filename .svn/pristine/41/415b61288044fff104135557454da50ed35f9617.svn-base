...
public class SurveyCdiChildWriterMapper implements CellWriterMapper<SurveyCdiChildVO>{
	@Override
	public void mapHeader(Row row, SurveyCdiChildVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyCdiChildVO vo) {
		Cell cell = null;
		int i = 0;
