...
public class SurveyIatWriterMapper implements CellWriterMapper<SurveyIatVO>{
	@Override
	public void mapHeader(Row row, SurveyIatVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyIatVO vo) {
		Cell cell = null;
		int i = 0;
