...
public class SurveyAsdKcriterionAdultWriterMapper implements CellWriterMapper<SurveyAsdKcriterionAdultVO>{
	@Override
	public void mapHeader(Row row, SurveyAsdKcriterionAdultVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyAsdKcriterionAdultVO vo) {
		Cell cell = null;
		int i = 0;
		cell = row.createCell(i++);
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getKcriterionAdultExecDate());
