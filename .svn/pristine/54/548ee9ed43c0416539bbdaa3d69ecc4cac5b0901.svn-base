...
public class SurveyBdiParentsWriterMapper implements CellWriterMapper<SurveyBdiParentsVO>{
	@Override
	public void mapHeader(Row row, SurveyBdiParentsVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyBdiParentsVO vo) {
		Cell cell = null;
		int i = 0;
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 6, 28));
