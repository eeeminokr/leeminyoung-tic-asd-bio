...
public class SurveyKbis11rWriterMapper implements CellWriterMapper<SurveyKbis11rVO>{
	@Override
	public void mapHeader(Row row, SurveyKbis11rVO vo) {
		Cell cell = null;
		int i = 0;
		...
		if(rowNum==1) {
			...
			cell.setCellValue("7");
			cell = row.createCell(i++);
			cell.setCellValue("7_역코딩");
			cell = row.createCell(i++);
			cell.setCellValue("8");
			cell = row.createCell(i++);
			cell.setCellValue("8_역코딩");
			cell = row.createCell(i++);
			cell.setCellValue("9");
			cell = row.createCell(i++);
			cell.setCellValue("9_역코딩");
			cell = row.createCell(i++);
			cell.setCellValue("10");
			cell = row.createCell(i++);
			cell.setCellValue("10_역코딩");
			cell = row.createCell(i++);
			cell.setCellValue("11");
			cell = row.createCell(i++);
			cell.setCellValue("12");
			cell = row.createCell(i++);
			cell.setCellValue("12_역코딩");
			cell = row.createCell(i++);
			cell.setCellValue("13");
			cell = row.createCell(i++);
			cell.setCellValue("13_역코딩");
			cell = row.createCell(i++);
			cell.setCellValue("14");
			cell = row.createCell(i++);
			cell.setCellValue("15");
			cell = row.createCell(i++);
			cell.setCellValue("15_역코딩");
			cell = row.createCell(i++);
			...
			cell = row.createCell(i++);
			cell.setCellValue("29_역코딩");
			cell = row.createCell(i++);
			cell.setCellValue("30");
			cell = row.createCell(i++);
			cell.setCellValue("30_역코딩");
			
		}
	}
	
	@Override
	public void mapRow(Row row, SurveyKbis11rVO vo) {
		Cell cell = null;
		int i = 0;
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getKbis11rExecDate());
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getA9Rc());

		cell = row.createCell(i++);
		cell.setCellValue(vo.getA10());
		
		cell = row.createCell(i++);
		cell.setCellValue(vo.getA10Rc());
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getA12Rc());

		cell = row.createCell(i++);
		cell.setCellValue(vo.getA13());
		
		cell = row.createCell(i++);
		cell.setCellValue(vo.getA13Rc());
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getA29Rc());
		
		cell = row.createCell(i++);
		cell.setCellValue(vo.getA30());
		
		cell = row.createCell(i++);
		cell.setCellValue(vo.getA30Rc());
	}
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 6, 46));
