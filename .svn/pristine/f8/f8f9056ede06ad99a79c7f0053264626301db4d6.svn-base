...
function doSearch() {
	...
	searchParams = {
		targetId : document.getElementById("targetId").value, //연구번호
		sex : checkSex,										// 성별
...
/*	var fileClassDtl = 'FIL04';
	...
	document.location.href = makeUrl('/medical/imagingInfo/imagingUploadExcelDownload.do', params);
*/	
	location.href = GLOBAL_CONTEXT_PATH + '/downFile.view?dir=file.sample.dir&fileName=ImagingInfoUpload.xlsx';
}
