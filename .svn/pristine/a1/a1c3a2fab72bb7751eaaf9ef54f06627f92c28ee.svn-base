...
public class SurveyAsdYbocsWriterMapper implements CellWriterMapper<SurveyAsdYbocsVO>{
	@Override
	public void mapHeader(Row row, SurveyAsdYbocsVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyAsdYbocsVO vo) {
		Cell cell = null;
		int i = 0;
