...
public class SurveyStaitYouthVO extends KoriginCommonVO{
	/**
	 * 
	 */
	...
	private String age;
	private String staitYouthExecDate;
	private String a1;  
	...
	public String getStaitYouthExecDate() {
		return staitYouthExecDate;
	}
	public void setStaitYouthExecDate(String staitYouthExecDate) {
		this.staitYouthExecDate = staitYouthExecDate;
	}
