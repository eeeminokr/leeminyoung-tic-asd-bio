...
public class SurveyAsdStaisParentsWriterMapper implements CellWriterMapper<SurveyAsdStaisParentsVO>{
	@Override
	public void mapHeader(Row row, SurveyAsdStaisParentsVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyAsdStaisParentsVO vo) {
		Cell cell = null;
		int i = 0;
		cell = row.createCell(i++);
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getStaisParentsExecDate());
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 7, 37));
