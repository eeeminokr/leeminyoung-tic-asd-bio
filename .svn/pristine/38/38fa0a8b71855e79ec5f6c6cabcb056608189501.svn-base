...
public class SurveyAsdStaitChildVO extends KoriginCommonVO{
	/**
	 * 
	 */
	private static final long serialVersionUID = -5968733089634103695L;
	private int rownum;
	...
	private String age;
	private String staitChildExecDate;
	private String a1;  
	private String a2;  
	private String a3;  
	private String a4;  
	...
	public String getStaitChildExecDate() {
		return staitChildExecDate;
	}
	public void setStaitChildExecDate(String staitChildExecDate) {
		this.staitChildExecDate = staitChildExecDate;
	}
