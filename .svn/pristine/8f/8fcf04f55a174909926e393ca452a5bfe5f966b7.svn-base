...
public class SurveyCybocsWriterMapper implements CellWriterMapper<SurveyCybocsVO>{
	@Override
	public void mapHeader(Row row, SurveyCybocsVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyCybocsVO vo) {
		Cell cell = null;
		int i = 0;
