...
public class SurveyAsdPc3q1WriterMapper implements CellWriterMapper<SurveyAsdPc3q1VO>{
	
	@Override
	public void mapHeader(Row row, SurveyAsdPc3q1VO vo) {
		Cell cell = null;
		int i = 0;
...
cell = row.createCell(i++);
	...
	@Override
	public void mapRow(Row row, SurveyAsdPc3q1VO vo) {
		Cell cell = null;
		int i = 0;
		cell = row.createCell(i++);
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getPc3q1ExecDate());
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 7, 111));
	}
}
