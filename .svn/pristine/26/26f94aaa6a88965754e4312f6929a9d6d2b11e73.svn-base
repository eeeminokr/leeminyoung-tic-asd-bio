...
public class SurveyAsdKcshqWriterMapper implements CellWriterMapper<SurveyAsdKcshqVO>{
	@Override
	public void mapHeader(Row row, SurveyAsdKcshqVO vo) {
		Cell cell = null;
		int i = 0;
		...
		if(rowNum==0) {
			...
			cell.setCellValue("수면");	
		
			cell = row.createCell(61);
			cell.setCellValue("수면행동");	
			
			cell = row.createCell(63);
			cell.setCellValue("아침에 일");	
			
			cell = row.createCell(65);
			cell.setCellValue("하위요인");	
		...
		if(rowNum==1) {
			...
			cell = row.createCell(i++);
			cell = row.createCell(i++);
			cell.setCellValue("1_역");
			cell = row.createCell(i++);
			cell.setCellValue("2_역");
			cell = row.createCell(i++);
			cell.setCellValue("3_역");
			cell = row.createCell(i++);
			cell.setCellValue("4");
			cell = row.createCell(i++);
			cell.setCellValue("5");
			...
			cell = row.createCell(i++);
			cell.setCellValue("15_역");
			cell = row.createCell(i++);
			cell.setCellValue("16_역");
			cell = row.createCell(i++);
			...
			cell = row.createCell(i++);
			cell.setCellValue("33_역");
			cell = row.createCell(i++);
			cell.setCellValue("34");
			cell = row.createCell(i++);
			cell.setCellValue("35_역");
			cell = row.createCell(i++);
			...
			cell = row.createCell(i++);
			cell.setCellValue("평일");
			cell = row.createCell(i++);
			cell.setCellValue("주말");
			cell = row.createCell(i++);
			cell.setCellValue("평일");
			cell = row.createCell(i++);
			cell.setCellValue("주말");
			...
			cell.setCellValue("주말");
			cell = row.createCell(i++);
			cell.setCellValue("입면저항");
			cell = row.createCell(i++);
			cell.setCellValue("임면 지연");
			cell = row.createCell(i++);
			cell.setCellValue("수면량");
			cell = row.createCell(i++);
			cell.setCellValue("수면 불안");
			cell = row.createCell(i++);
			cell.setCellValue("입면 후 각성");
			cell = row.createCell(i++);
			cell.setCellValue("사건 수면");
			cell = row.createCell(i++);
			cell.setCellValue("수면 호흡 장애");
			cell = row.createCell(72);
			cell.setCellValue("주간 졸림 증상");
			
		}
	}
	
	@Override
	public void mapRow(Row row, SurveyAsdKcshqVO vo) {
		Cell cell = null;
		int i = 0;
		cell = row.createCell(i++);
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getKcshqExecDate());

		cell = row.createCell(i++);
		cell.setCellValue(vo.getA1Rc());

		cell = row.createCell(i++);
		cell.setCellValue(vo.getA2Rc());

		cell = row.createCell(i++);
		cell.setCellValue(vo.getA3Rc());
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getA15Rc());

		cell = row.createCell(i++);
		cell.setCellValue(vo.getA16Rc());
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getA33Rc());
		
		cell = row.createCell(i++);
		cell.setCellValue(vo.getA34());
		
		cell = row.createCell(i++);
		cell.setCellValue(vo.getA35Rc());
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 7, 58));
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 59, 60));
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 61, 62));
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 63, 64));
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 65, 72));
		sheet.addMergedRegion(new CellRangeAddress(1, 1, 72, 72));
	}
