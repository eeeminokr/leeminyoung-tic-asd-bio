...
public class SurveyStaitChildWriterMapper implements CellWriterMapper<SurveyStaitChildVO>{
	@Override
	public void mapHeader(Row row, SurveyStaitChildVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyStaitChildVO vo) {
		Cell cell = null;
		int i = 0;
