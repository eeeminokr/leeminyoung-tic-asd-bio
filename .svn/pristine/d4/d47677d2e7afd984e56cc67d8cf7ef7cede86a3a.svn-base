...
public class SurveyAsdCbcl2WriterMapper implements CellWriterMapper<SurveyAsdCbcl2VO>{
	@Override
	public void mapHeader(Row row, SurveyAsdCbcl2VO vo) {
		Cell cell = null;
		int i = 0;
		...
		cell = row.createCell(i++);
		cell.setCellValue("문제행동척도 프로파일");	
		
		cell = row.createCell(19);
		cell.setCellValue("DSM 집단척도");	
		
		cell = row.createCell(25);
		cell.setCellValue("문제행동특수척도 프로파일");	
		
		cell = row.createCell(28);
		cell.setCellValue("적응정도프로파일");
		...
		if(rowNum==1) {
			...
			cell = row.createCell(i++);
			cell.setCellValue("신체화문제");
			cell = row.createCell(i++);
			cell.setCellValue("ADHD");
			cell = row.createCell(i++);
			cell.setCellValue("반항행동문제");
			cell = row.createCell(i++);
			cell.setCellValue("품행문제");
			cell = row.createCell(i++);
			cell.setCellValue("강박증상");
			cell = row.createCell(i++);
			cell.setCellValue("외상후스트레스문제");
			cell = row.createCell(i++);
			cell.setCellValue("인지속도부진");
			cell = row.createCell(i++);
			cell.setCellValue("적응척도총점");
			cell = row.createCell(i++);
			cell.setCellValue("사회성");
			cell = row.createCell(i++);
			cell.setCellValue("학업수행");
			...
			cell.setCellValue("56a");cell = row.createCell(i++);
			cell.setCellValue("56b");cell = row.createCell(i++);
			cell.setCellValue("56c");cell = row.createCell(i++);
			cell.setCellValue("56d");cell = row.createCell(i++);
			cell.setCellValue("56e");cell = row.createCell(i++);
			cell.setCellValue("56f");cell = row.createCell(i++);
			cell.setCellValue("56g");cell = row.createCell(i++);
			cell.setCellValue("56h");cell = row.createCell(i++);
			...
			cell.setCellValue("101");cell = row.createCell(i++);
			cell.setCellValue("102");cell = row.createCell(i++);
			cell.setCellValue("103");cell = row.createCell(i++);
			cell.setCellValue("104");cell = row.createCell(i++);
			cell.setCellValue("105");cell = row.createCell(i++);
			cell.setCellValue("106");cell = row.createCell(i++);
			cell.setCellValue("107");cell = row.createCell(i++);
			cell.setCellValue("108");cell = row.createCell(i++);
			cell.setCellValue("109");cell = row.createCell(i++);
			cell.setCellValue("110");cell = row.createCell(i++);
			cell.setCellValue("111");cell = row.createCell(i++);
			cell.setCellValue("112");cell = row.createCell(i++);
			cell.setCellValue("113");cell = row.createCell(i++);
			cell.setCellValue("113-1");cell = row.createCell(i++);
			cell.setCellValue("113-2");cell = row.createCell(i++);
			cell.setCellValue("113-3");
		}
	}
	
	@Override
	public void mapRow(Row row, SurveyAsdCbcl2VO vo) {
		Cell cell = null;
		int i = 0;
		...
		cell.setCellValue(vo.getA120());cell = row.createCell(i++);
		cell.setCellValue(vo.getA121());cell = row.createCell(i++);
		cell.setCellValue(vo.getA122());cell = row.createCell(i++);
		cell.setCellValue(vo.getA123());cell = row.createCell(i++);
		cell.setCellValue(vo.getA124());cell = row.createCell(i++);
		cell.setCellValue(vo.getA125());cell = row.createCell(i++);
		cell.setCellValue(vo.getA126());cell = row.createCell(i++);
		cell.setCellValue(vo.getA127());cell = row.createCell(i++);
		cell.setCellValue(vo.getA128());cell = row.createCell(i++);
		cell.setCellValue(vo.getA129());cell = row.createCell(i++);
		cell.setCellValue(vo.getA130());cell = row.createCell(i++);
		cell.setCellValue(vo.getA131());cell = row.createCell(i++);
		cell.setCellValue(vo.getA132());cell = row.createCell(i++);
		cell.setCellValue(vo.getA133());cell = row.createCell(i++);
		cell.setCellValue(vo.getA134());cell = row.createCell(i++);
		cell.setCellValue(vo.getA135());cell = row.createCell(i++);
		cell.setCellValue(vo.getA136());cell = row.createCell(i++);
		cell.setCellValue(vo.getA137());cell = row.createCell(i++);
		cell.setCellValue(vo.getA138());cell = row.createCell(i++);
		cell.setCellValue(vo.getA139());cell = row.createCell(i++);
		cell.setCellValue(vo.getA140());cell = row.createCell(i++);
		cell.setCellValue(vo.getA141());cell = row.createCell(i++);
		cell.setCellValue(vo.getA142());cell = row.createCell(i++);
		cell.setCellValue(vo.getA143());cell = row.createCell(i++);
		cell.setCellValue(vo.getA144());cell = row.createCell(i++);
		cell.setCellValue(vo.getA145());cell = row.createCell(i++);
		cell.setCellValue(vo.getA146());cell = row.createCell(i++);
		cell.setCellValue(vo.getA147());
	}
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 31, 153));
