...
public class SurveyAsdCdiChildWriterMapper implements CellWriterMapper<SurveyAsdCdiChildVO>{
	@Override
	public void mapHeader(Row row, SurveyAsdCdiChildVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyAsdCdiChildVO vo) {
		Cell cell = null;
		int i = 0;
		cell = row.createCell(i++);
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getCdiChildExecDate());
