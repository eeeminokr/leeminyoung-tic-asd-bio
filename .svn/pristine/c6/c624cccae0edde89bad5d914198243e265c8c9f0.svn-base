...
<script type="text/javascript" src="${contextPath}/js/medical/clinician/clinicianListAoAdhd.js"></script>
<style type="text/css">
	...
	<div id="BodyDiv">  
		...
		<form id="searchForm" name="searchForm" onsubmit="doSearch(); return false;">
			...
			<div class="btns">
				...
				<button type="button" onclick="selectDeleteClinician();" class="btnsStyle"><img src="${contextPath}/images/img/ico_del.png" alt="" /><span>삭제</span></button>
				</eco:authorize>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <div class="cont check_btns">
                            <input type="checkbox" id="sex_m" name="check_sex" class="first" value="M" /><label for="sex_m">남자</label><input type="checkbox" name="check_sex" id="sex_f" value="F"/><label for="sex_f">여자</label>
                        </div>
                    </li>
                    <li>
                    ...
                    <li>
                        <div class="check_right" id="check_right">
							<label><input type="checkbox" name="cvCgis" /><span>CGI-S</span></label>
	                            ...
	                            <label><input type="checkbox" name="exts1" /><span>K-SADS-PL</span></label>
