...
public class SurveyVO extends KoriginCommonVO{

	/**
	 * 
	 */
	private static final long serialVersionUID = -5547213591848257638L;
	private int rownum;
	private String sex;
	private String birthYm;
	private String age;
	private String execDate;
	private String surveyExecDate;
    ...
    public String getSurveyExecDate() {
		return surveyExecDate;
	}
	public void setSurveyExecDate(String surveyExecDate) {
		this.surveyExecDate = surveyExecDate;
	}
