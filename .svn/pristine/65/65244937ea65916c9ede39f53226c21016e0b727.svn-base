...
public class SurveyAsdCpclVO extends KoriginCommonVO{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6453259170665282607L;
	...
	private String age;
	private String cpclExecDate;
	
	private String sentence;
	private String tDiagnosis;
...
//	private String totalScore;
	...
	public String getCpclExecDate() {
		return cpclExecDate;
	}
	public void setCpclExecDate(String cpclExecDate) {
		this.cpclExecDate = cpclExecDate;
	}
	...
	public String gettDiagnosis() {
		return tDiagnosis;
	}
	public void settDiagnosis(String tDiagnosis) {
		this.tDiagnosis = tDiagnosis;
	}
