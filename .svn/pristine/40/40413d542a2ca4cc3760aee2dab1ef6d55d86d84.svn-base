...
public class SurveyStaisYouthVO extends KoriginCommonVO{
	/**
	 * 
	 */
	...
	private String age;
	private String staisYouthExecDate;
	private String a1;  		
	...
	public String getStaisYouthExecDate() {
		return staisYouthExecDate;
	}
	public void setStaisYouthExecDate(String staisYouthExecDate) {
		this.staisYouthExecDate = staisYouthExecDate;
	}
