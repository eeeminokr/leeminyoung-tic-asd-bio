...
public class SurveyMbriWriterMapper implements CellWriterMapper<SurveyMbriVO>{
	@Override
	public void mapHeader(Row row, SurveyMbriVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyMbriVO vo) {
		Cell cell = null;
		int i = 0;
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 6, 58));
