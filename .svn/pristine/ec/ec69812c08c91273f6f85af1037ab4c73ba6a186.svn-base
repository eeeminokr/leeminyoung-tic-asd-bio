...
public class SurveyKcriterionWriterMapper implements CellWriterMapper<SurveyKcriterionVO>{
	@Override
	public void mapHeader(Row row, SurveyKcriterionVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyKcriterionVO vo) {
		Cell cell = null;
		int i = 0;
