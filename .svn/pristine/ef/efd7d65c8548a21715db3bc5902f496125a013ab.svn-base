...
public class SurveyDbdsVO extends KoriginCommonVO{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -2185655244940551069L;
	private int rownum;
	...
	private String odd;
	private String cd;
	private String odd2;	//2점
	private String odd3;	//3점
	...
	public String getDbdsExecDate() {
		return dbdsExecDate;
	}
	public void setDbdsExecDate(String dbdsExecDate) {
		this.dbdsExecDate = dbdsExecDate;
	}
