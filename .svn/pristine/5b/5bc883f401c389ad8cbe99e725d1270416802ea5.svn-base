...
public class SurveyAsdKmchatVO extends KoriginCommonVO{
	/**
	 * 
	 */
	private static final long serialVersionUID = -5449761468325147290L;
	private int rownum;
	...
	public String getKmchatExecDate() {
		return kmchatExecDate;
	}
	public void setKmchatExecDate(String kmchatExecDate) {
		this.kmchatExecDate = kmchatExecDate;
	}
