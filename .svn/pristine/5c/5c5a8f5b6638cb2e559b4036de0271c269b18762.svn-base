...
public class SurveyDbdsWriterMapper implements CellWriterMapper<SurveyDbdsVO>{
	@Override
	public void mapHeader(Row row, SurveyDbdsVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyDbdsVO vo) {
		Cell cell = null;
		int i = 0;
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getDbdsExecDate());
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getAdhd());

		cell = row.createCell(i++);
		cell.setCellValue(vo.getOdd());

		cell = row.createCell(i++);
		cell.setCellValue(vo.getCd());
		
		cell = row.createCell(i++);
		cell.setCellValue(vo.getOdd2());
		
		cell = row.createCell(i++);
		cell.setCellValue(vo.getOdd3());
	}
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 6, 51));
