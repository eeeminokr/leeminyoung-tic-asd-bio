...
public class SurveyAsdRcmasVO extends KoriginCommonVO{
	/**
	 * 
	 */
	private static final long serialVersionUID = 6256274796204427662L;
	private int rownum;
	...
	public String getRcmasExecDate() {
		return rcmasExecDate;
	}
	public void setRcmasExecDate(String rcmasExecDate) {
		this.rcmasExecDate = rcmasExecDate;
	}
