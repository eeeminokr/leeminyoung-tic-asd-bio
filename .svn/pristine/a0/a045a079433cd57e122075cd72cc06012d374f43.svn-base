...
public class SurveyStaitYouthWriterMapper implements CellWriterMapper<SurveyStaitYouthVO> {

	
	@Override
	public void mapHeader(Row row, SurveyStaitYouthVO vo) {
		Cell cell = null;
		int i = 0;
		...
		if(rowNum==1) {
			...
			cell.setCellValue("6");
			cell = row.createCell(i++);
			cell.setCellValue("6_역");
			cell = row.createCell(i++);
			cell.setCellValue("7");
			cell = row.createCell(i++);
			cell.setCellValue("7_역");
			cell = row.createCell(i++);
			cell.setCellValue("8");
			cell = row.createCell(i++);
			cell.setCellValue("9");
	...
	@Override
	public void mapRow(Row row, SurveyStaitYouthVO vo) {
		Cell cell = null;
		int i = 0;
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getStaitYouthExecDate());
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 6, 33));	
	}
