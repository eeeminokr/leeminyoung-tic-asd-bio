...
public class SurveyAsdCbcl2VO extends KoriginCommonVO{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 6375750928990617448L;
	...
	public String getCbclExecDate() {
		return cbclExecDate;
	}
	public void setCbclExecDate(String cbclExecDate) {
		this.cbclExecDate = cbclExecDate;
	}
	public String getA1() {
		return a1;
	}
