...
public class SurveyAsdScqWriterMapper implements CellWriterMapper<SurveyAsdScqVO>{
	@Override
	public void mapHeader(Row row, SurveyAsdScqVO vo) {
		Cell cell = null;
		int i = 0;
		...
		if(rowNum==0) {
			...
			cell.setCellValue("SCQ(current)");
			
			cell = row.createCell(48);
			cell.setCellValue("SCQ(lifetime)");
	...
	@Override
	public void mapRow(Row row, SurveyAsdScqVO vo) {
		Cell cell = null;
		int i = 0;
		cell = row.createCell(i++);
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getScqExecDate());

		cell = row.createCell(i++);
		cell.setCellValue(vo.getcTotalScore());
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getlTotalScore());
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 7, 47));
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 48, 88));
