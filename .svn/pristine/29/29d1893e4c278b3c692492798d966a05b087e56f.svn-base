...
<script type="text/javascript" src="${contextPath}/js/medical/dataIntegration/dataIntegrationDtl.js"></script>
				...
				<div class="box_style">
					...
					<div class="box_body box_scroll" style="height:118px;">
						<table>
							...
							<tbody>
								<tr class="bg clinical_e4_tr"  id="4interval">
									<th>항목</th>
									<th>차수</th>
									<th>실시일</th>
									<th>결과</th>
					...
					<div class="slide_wrap">
                        <div id="slider" class="slide_inner">
							<div class="survey_btns">
								<h3>부모자녀 평가</h3>
								<button type="button" class="survey_btn" id="ARS01" onclick="docDtlLoad('ARS01')">ARS</button>
								<button type="button" class="survey_btn" id="KCBCL" onclick="docDtlLoad('KCBCL')">CBCL</button>
								<button type="button" class="survey_btn" id="DBDS1" onclick="docDtlLoad('DBDS1')">DBDS</button>
								<button type="button" class="survey_btn" id="CMRSP" onclick="docDtlLoad('CMRSP')">CMRS-P</button>
								<button type="button" class="survey_btn" id="TRAUM" onclick="docDtlLoad('TRAUM')">트라우마</button>
							</div>
							<div class="survey_btns">
								<h3>아동자가 평가</h3>
								...
								<button type="button" class="survey_btn" id="STITC" onclick="docDtlLoad('STITC')">STAI-T<br />(아동)</button>
								<button type="button" class="survey_btn" id="STISC" onclick="docDtlLoad('STISC')">STAI-S<br />(아동)</button>
								<button type="button" class="survey_btn" id="STITY" onclick="docDtlLoad('STITY')">STAI-T<br />(청소년)</button>
								<button type="button" class="survey_btn" id="STISY" onclick="docDtlLoad('STISY')">STAI-S<br />(청소년)</button>
								<button type="button" class="survey_btn" id="LOICV" onclick="docDtlLoad('LOICV')">LOI-CV</button>
								<button type="button" class="survey_btn" id="KBIS1" onclick="docDtlLoad('KBIS1')">K-Bis-11-R</button>
							</div>
							<div class="survey_btns">
								<h3>부모자가 평가</h3>
								<button type="button" class="survey_btn" id="BDI01" onclick="docDtlLoad('BDI01')">BDI</button>
								<button type="button" class="survey_btn" id="STITP" onclick="docDtlLoad('STITP')">STAI-T<br />(부모)</button>
								<button type="button" class="survey_btn" id="STISP" onclick="docDtlLoad('STISP')">STAI-S<br />(부모)</button>
								<button type="button" class="survey_btn" id="MBRI1" onclick="docDtlLoad('MBRI1')">MBRI</button>
								<button type="button" class="survey_btn" id="KADHD" onclick="docDtlLoad('KADHD')">K-AADHDS</button>
								<button type="button" class="survey_btn" id="KPSI1" onclick="docDtlLoad('KPSI1')">K-PSI</button>
							</div>
							<div class="survey_btns">
								<h3>4주 간격 면담지</h3>
								<button type="button" class="survey_btn" id="SRS02" onclick="docDtlLoad('SRS02')">SRS</button>
								<button type="button" class="survey_btn" id="YGTS2" onclick="docDtlLoad('YGTS2')">YGTSS</button>
								<button type="button" class="survey_btn" id="CYBO2" onclick="docDtlLoad('CYBO2')">YBOCS</button>
								<button type="button" class="survey_btn" id="CYBO3" onclick="docDtlLoad('CYBO3')">YBOCS(부모)</button>
							</div>
							<div class="survey_btns">
								<h3>임상가 평가</h3>
								<button type="button" class="survey_btn" id="SRS01" onclick="docDtlLoad('SRS01')">SRS</button>
								<button type="button" class="survey_btn" id="YGTS1" onclick="docDtlLoad('YGTS1')">YGTSS</button>
								<button type="button" class="survey_btn" id="YBOCA" onclick="docDtlLoad('YBOCA')">YBOCS</button>
								<button type="button" class="survey_btn" id="YBOCS" onclick="docDtlLoad('YBOCS')">YBOCS(부모)</button>
							</div>
						</div>
					</div>
				</div>
