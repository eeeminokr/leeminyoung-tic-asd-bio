...
public class SurveyCmrspWriterMapper implements CellWriterMapper<SurveyCmrspVO>{
	@Override
	public void mapHeader(Row row, SurveyCmrspVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyCmrspVO vo) {
		Cell cell = null;
		int i = 0;
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 6, 27));
