...
public class NeuropsyCatWriterMapper implements CellWriterMapper<NeuropsyCatVO>{
	@Override
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 30, 37));
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 38, 45));
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 46, 53));
