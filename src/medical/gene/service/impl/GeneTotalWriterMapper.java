...
public class GeneTotalWriterMapper implements CellWriterMapper<GeneTotalVO>{
	@Override
	public void mapHeader(Row row, GeneTotalVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, GeneTotalVO vo) {
		Cell cell = null;
		int i = 0;
