...
public class SurveyAsdKpsiWriterMapper implements CellWriterMapper<SurveyAsdKpsiVO>{
	@Override
	public void mapHeader(Row row, SurveyAsdKpsiVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyAsdKpsiVO vo) {
		Cell cell = null;
		int i = 0;
		cell = row.createCell(i++);
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 7, 143));
		sheet.addMergedRegion(new CellRangeAddress(1, 1, 143, 143));
	}
