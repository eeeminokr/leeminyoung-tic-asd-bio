...
public class SurveyAsdCmrspWriterMapper implements CellWriterMapper<SurveyAsdCmrspVO>{
	@Override
	public void mapHeader(Row row, SurveyAsdCmrspVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyAsdCmrspVO vo) {
		Cell cell = null;
		int i = 0;
		cell = row.createCell(i++);
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getCmrspExecDate());
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 7, 28));
