...
public class SurveyAsdKcriterionWriterMapper implements CellWriterMapper<SurveyAsdKcriterionVO>{
	@Override
	public void mapHeader(Row row, SurveyAsdKcriterionVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyAsdKcriterionVO vo) {
		Cell cell = null;
		int i = 0;
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getKcriterionExecDate());
