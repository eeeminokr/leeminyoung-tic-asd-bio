...
public class SurveyAsdGsrsWriterMapper implements CellWriterMapper<SurveyAsdGsrsVO>{
	@Override
	public void mapHeader(Row row, SurveyAsdGsrsVO vo) {
		Cell cell = null;
		int i = 0;
		...
		if(rowNum==1) {
			...
			cell.setCellValue("9");
			cell = row.createCell(i++);
			cell.setCellValue("10(1)");
			cell = row.createCell(i++);
			cell.setCellValue("10(2)");
			cell = row.createCell(i++);
			cell.setCellValue("10(3)");
			cell = row.createCell(i++);
			cell.setCellValue("10(4)");
			cell = row.createCell(i++);
			cell.setCellValue("10(5)");
			cell = row.createCell(i++);
			cell.setCellValue("10(6)");
			
		}
	}
	
	@Override
	public void mapRow(Row row, SurveyAsdGsrsVO vo) {
		Cell cell = null;
		int i = 0;
		cell = row.createCell(i++);
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getGsrsExecDate());
