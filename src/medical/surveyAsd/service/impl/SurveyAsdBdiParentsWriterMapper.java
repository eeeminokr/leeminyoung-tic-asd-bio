...
public class SurveyAsdBdiParentsWriterMapper implements CellWriterMapper<SurveyAsdBdiParentsVO>{
	@Override
	public void mapHeader(Row row, SurveyAsdBdiParentsVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyAsdBdiParentsVO vo) {
		Cell cell = null;
		int i = 0;
		cell = row.createCell(i++);
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getBdiParentsExecDate());
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getWeightControl());
