...
public class SurveyAsdPp3q1WriterMapper implements CellWriterMapper<SurveyAsdPp3q1VO>{
	@Override
	public void mapHeader(Row row, SurveyAsdPp3q1VO vo) {
		Cell cell = null;
		int i = 0;
		...
		if(rowNum==0) {
			...
			cell.setCellValue("부모자가평가 (AQ/EQ/SQ) 성인용");
		...
		if(rowNum==1) {
			...
			cell.setCellValue("총합(1-60)");cell = row.createCell(i++);
			...
			cell.setCellValue("총합(1-75)");cell = row.createCell(i++);
			...
			cell.setCellValue("49");cell = row.createCell(i++);
			cell.setCellValue("50");cell = row.createCell(i++);
			cell.setCellValue("총합(1-50)");
		}
	}
	
	@Override
	public void mapRow(Row row, SurveyAsdPp3q1VO vo) {
		Cell cell = null;
		int i = 0;
		cell = row.createCell(i++);
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getPp3q1ExecDate());
		...
		cell.setCellValue(vo.getScoreA());cell = row.createCell(i++);
		...
		cell.setCellValue(vo.getB14());cell = row.createCell(i++);
		cell.setCellValue(vo.getB15());cell = row.createCell(i++);
		cell.setCellValue(vo.getB16());cell = row.createCell(i++);
		cell.setCellValue(vo.getB17());cell = row.createCell(i++);
		cell.setCellValue(vo.getB18());cell = row.createCell(i++);
		cell.setCellValue(vo.getB19());cell = row.createCell(i++);
		cell.setCellValue(vo.getB20());cell = row.createCell(i++);
		cell.setCellValue(vo.getB21());cell = row.createCell(i++);
		cell.setCellValue(vo.getB22());cell = row.createCell(i++);
		cell.setCellValue(vo.getB23());cell = row.createCell(i++);
		cell.setCellValue(vo.getB24());cell = row.createCell(i++);
		cell.setCellValue(vo.getB25());cell = row.createCell(i++);
		cell.setCellValue(vo.getB26());cell = row.createCell(i++);
		cell.setCellValue(vo.getB27());cell = row.createCell(i++);
		cell.setCellValue(vo.getB28());cell = row.createCell(i++);
		cell.setCellValue(vo.getB29());cell = row.createCell(i++);
		cell.setCellValue(vo.getB30());cell = row.createCell(i++);
		cell.setCellValue(vo.getB31());cell = row.createCell(i++);
		cell.setCellValue(vo.getB32());cell = row.createCell(i++);
		cell.setCellValue(vo.getB33());cell = row.createCell(i++);
		cell.setCellValue(vo.getB34());cell = row.createCell(i++);
		cell.setCellValue(vo.getB35());cell = row.createCell(i++);
		cell.setCellValue(vo.getB36());cell = row.createCell(i++);
		cell.setCellValue(vo.getB37());cell = row.createCell(i++);
		cell.setCellValue(vo.getB38());cell = row.createCell(i++);
		cell.setCellValue(vo.getB39());cell = row.createCell(i++);
		cell.setCellValue(vo.getB40());cell = row.createCell(i++);
		cell.setCellValue(vo.getB41());cell = row.createCell(i++);
		cell.setCellValue(vo.getB42());cell = row.createCell(i++);
		cell.setCellValue(vo.getB43());cell = row.createCell(i++);
		cell.setCellValue(vo.getB44());cell = row.createCell(i++);
		cell.setCellValue(vo.getB45());cell = row.createCell(i++);
		cell.setCellValue(vo.getB46());cell = row.createCell(i++);
		cell.setCellValue(vo.getB47());cell = row.createCell(i++);
		cell.setCellValue(vo.getB48());cell = row.createCell(i++);
		cell.setCellValue(vo.getB49());cell = row.createCell(i++);
		cell.setCellValue(vo.getB50());cell = row.createCell(i++);
		cell.setCellValue(vo.getB51());cell = row.createCell(i++);
		cell.setCellValue(vo.getB52());cell = row.createCell(i++);
		cell.setCellValue(vo.getB53());cell = row.createCell(i++);
		cell.setCellValue(vo.getB54());cell = row.createCell(i++);
		cell.setCellValue(vo.getB55());cell = row.createCell(i++);
		cell.setCellValue(vo.getB56());cell = row.createCell(i++);
		cell.setCellValue(vo.getB57());cell = row.createCell(i++);
		cell.setCellValue(vo.getB58());cell = row.createCell(i++);
		cell.setCellValue(vo.getB59());cell = row.createCell(i++);
		cell.setCellValue(vo.getB60());cell = row.createCell(i++);
		cell.setCellValue(vo.getB61());cell = row.createCell(i++);
		cell.setCellValue(vo.getB62());cell = row.createCell(i++);
		cell.setCellValue(vo.getB63());cell = row.createCell(i++);
		cell.setCellValue(vo.getB64());cell = row.createCell(i++);
		cell.setCellValue(vo.getB65());cell = row.createCell(i++);
		cell.setCellValue(vo.getB66());cell = row.createCell(i++);
		cell.setCellValue(vo.getB67());cell = row.createCell(i++);
		cell.setCellValue(vo.getB68());cell = row.createCell(i++);
		cell.setCellValue(vo.getB69());cell = row.createCell(i++);
		cell.setCellValue(vo.getB70());cell = row.createCell(i++);
		cell.setCellValue(vo.getB71());cell = row.createCell(i++);
		cell.setCellValue(vo.getB72());cell = row.createCell(i++);
		cell.setCellValue(vo.getB73());cell = row.createCell(i++);
		cell.setCellValue(vo.getB74());cell = row.createCell(i++);
		cell.setCellValue(vo.getB75());cell = row.createCell(i++);
		cell.setCellValue(vo.getScoreB());cell = row.createCell(i++);
		...
		cell.setCellValue(vo.getC12());cell = row.createCell(i++);
		cell.setCellValue(vo.getC13());cell = row.createCell(i++);
		cell.setCellValue(vo.getC14());cell = row.createCell(i++);
		cell.setCellValue(vo.getC15());cell = row.createCell(i++);
		cell.setCellValue(vo.getC16());cell = row.createCell(i++);
		cell.setCellValue(vo.getC17());cell = row.createCell(i++);
		cell.setCellValue(vo.getC18());cell = row.createCell(i++);
		cell.setCellValue(vo.getC19());cell = row.createCell(i++);
		cell.setCellValue(vo.getC20());cell = row.createCell(i++);
		cell.setCellValue(vo.getC21());cell = row.createCell(i++);
		cell.setCellValue(vo.getC22());cell = row.createCell(i++);
		cell.setCellValue(vo.getC23());cell = row.createCell(i++);
		cell.setCellValue(vo.getC24());cell = row.createCell(i++);
		cell.setCellValue(vo.getC25());cell = row.createCell(i++);
		cell.setCellValue(vo.getC26());cell = row.createCell(i++);
		cell.setCellValue(vo.getC27());cell = row.createCell(i++);
		cell.setCellValue(vo.getC28());cell = row.createCell(i++);
		cell.setCellValue(vo.getC29());cell = row.createCell(i++);
		cell.setCellValue(vo.getC30());cell = row.createCell(i++);
		cell.setCellValue(vo.getC31());cell = row.createCell(i++);
		cell.setCellValue(vo.getC32());cell = row.createCell(i++);
		cell.setCellValue(vo.getC33());cell = row.createCell(i++);
		cell.setCellValue(vo.getC34());cell = row.createCell(i++);
		cell.setCellValue(vo.getC35());cell = row.createCell(i++);
		cell.setCellValue(vo.getC36());cell = row.createCell(i++);
		cell.setCellValue(vo.getC37());cell = row.createCell(i++);
		cell.setCellValue(vo.getC38());cell = row.createCell(i++);
		cell.setCellValue(vo.getC39());cell = row.createCell(i++);
		cell.setCellValue(vo.getC40());cell = row.createCell(i++);
		cell.setCellValue(vo.getC41());cell = row.createCell(i++);
		cell.setCellValue(vo.getC42());cell = row.createCell(i++);
		cell.setCellValue(vo.getC43());cell = row.createCell(i++);
		cell.setCellValue(vo.getC44());cell = row.createCell(i++);
		cell.setCellValue(vo.getC45());cell = row.createCell(i++);
		cell.setCellValue(vo.getC46());cell = row.createCell(i++);
		cell.setCellValue(vo.getC47());cell = row.createCell(i++);
		cell.setCellValue(vo.getC48());cell = row.createCell(i++);
		cell.setCellValue(vo.getC49());cell = row.createCell(i++);
		cell.setCellValue(vo.getC50());cell = row.createCell(i++);
		cell.setCellValue(vo.getScoreC());
	}
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 7, 194));
	}
