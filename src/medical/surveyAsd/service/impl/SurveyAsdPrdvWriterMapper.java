...
public class SurveyAsdPrdvWriterMapper implements CellWriterMapper<SurveyAsdPrdvVO>{
	@Override
	public void mapHeader(Row row, SurveyAsdPrdvVO vo) {
		Cell cell = null;
		int i = 0;
		...
		cell.setCellValue("연령대(ENROLL 기준)");	
		...
		cell = row.createCell(267);
		cell.setCellValue("아이의 건강");	
		
		cell = row.createCell(323);
		cell.setCellValue("학습 및 사회성");	
		
		cell = row.createCell(339);
		cell.setCellValue("사춘기여부");	
		cell = row.createCell(345);
		}
		if(rowNum==1) {
	...
	@Override
	public void mapRow(Row row, SurveyAsdPrdvVO vo) {
		Cell cell = null;
		int i = 0;
		cell = row.createCell(i++);
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 8, 27)); 		//a
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 28, 82)); 		//b
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 83, 142)); 	//c 
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 143, 170)); 	//d
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 171, 208)); 	//e
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 209, 266)); 	//f
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 267, 322)); 	//g
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 323, 338)); 	//h
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 339, 345)); 	//i
	}
}
