...
public class SurveyAsdIatWriterMapper implements CellWriterMapper<SurveyAsdIatVO>{
	@Override
	public void mapHeader(Row row, SurveyAsdIatVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyAsdIatVO vo) {
		Cell cell = null;
		int i = 0;
		cell = row.createCell(i++);
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getIatExecDate());
