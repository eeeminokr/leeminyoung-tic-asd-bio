...
public class SurveyAsdSrs03WriterMapper implements CellWriterMapper<SurveyAsdSrs03VO>{
	@Override
	public void mapHeader(Row row, SurveyAsdSrs03VO vo) {
		Cell cell = null;
		int i = 0;
		...
		if(rowNum==1) {
			...
			cell = row.createCell(i++);
			cell.setCellValue("missing values");
			cell = row.createCell(i++);
			cell.setCellValue("social awareness");
			cell = row.createCell(i++);
			cell.setCellValue("social cognition");
			cell = row.createCell(i++);
			cell.setCellValue("social communicaion");
			cell = row.createCell(i++);
			cell.setCellValue("social motivaion");
			cell = row.createCell(i++);
			cell.setCellValue("restricted interests and repetitive behavior");
			cell = row.createCell(i++);
			cell.setCellValue("SCI");
			cell = row.createCell(i++);
			cell.setCellValue("total");
			cell = row.createCell(i++);
			cell.setCellValue("social awareness T");
			cell = row.createCell(i++);
			cell.setCellValue("social cognition T");
			cell = row.createCell(i++);
			cell.setCellValue("social communication T");
			cell = row.createCell(i++);
			cell.setCellValue("social motivation T");
			cell = row.createCell(i++);
			cell.setCellValue("restricted interests and repetitive behavior T");
			cell = row.createCell(i++);
			cell.setCellValue("SCI");
			cell = row.createCell(i++);
			cell.setCellValue("total T");
		}
	}
	
	@Override
	public void mapRow(Row row, SurveyAsdSrs03VO vo) {
		Cell cell = null;
		int i = 0;
		cell = row.createCell(i++);
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getSrs03ExecDate());
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 7, 86));
