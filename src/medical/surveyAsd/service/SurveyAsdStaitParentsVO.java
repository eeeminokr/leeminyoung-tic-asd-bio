...
public class SurveyAsdStaitParentsVO extends KoriginCommonVO{
	/**
	 * 
	 */
	private static final long serialVersionUID = -1057760567013824132L;
	private int rownum;
	...
	private String age;
	private String staitParentsExecDate;
	private String a1;  
	...
	public String getStaitParentsExecDate() {
		return staitParentsExecDate;
	}
	public void setStaitParentsExecDate(String staitParentsExecDate) {
		this.staitParentsExecDate = staitParentsExecDate;
	}
	...
	public String getA6Rc() {
		return a6Rc;
	}
	public void setA6Rc(String a6Rc) {
		this.a6Rc = a6Rc;
	}
	public String getA7() {
		return a7;
