...
public class SurveyAsdCmrspVO extends KoriginCommonVO{
	/**
	 * 
	 */
	private static final long serialVersionUID = -1322779719472509163L;
	private int rownum;
	...
	public String getCmrspExecDate() {
		return cmrspExecDate;
	}
	public void setCmrspExecDate(String cmrspExecDate) {
		this.cmrspExecDate = cmrspExecDate;
	}
