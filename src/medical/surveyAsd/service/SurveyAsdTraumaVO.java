...
public class SurveyAsdTraumaVO extends KoriginCommonVO{
	/**
	 * 
	 */
	private static final long serialVersionUID = -3360593268115041300L;
	private int rownum;
	...
	private String a26; 
	private String a27; 
	private String a28;		//가장 큰영향 준 항목 (","구분자 복수개의 데이터)
	private String a29;		//공포/무력감 (","구분자 복수개 데이터)
	private String a30;		//꿈을 꾸는 느낌 (","구분자 복수개 데이터)
	...
	public String getTraumaExecDate() {
		return traumaExecDate;
	}
	public void setTraumaExecDate(String traumaExecDate) {
		this.traumaExecDate = traumaExecDate;
	}
