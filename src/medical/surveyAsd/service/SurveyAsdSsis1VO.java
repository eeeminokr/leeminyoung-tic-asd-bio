...
public class SurveyAsdSsis1VO extends KoriginCommonVO{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -6501084055010520160L;
	...
	public String getSsisExecDate() {
		return ssisExecDate;
	}
	public void setSsisExecDate(String ssisExecDate) {
		this.ssisExecDate = ssisExecDate;
	}
	public String getA1() {
		return a1;
	}
