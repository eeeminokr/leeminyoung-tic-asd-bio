...
public class SurveyAsdIatVO extends KoriginCommonVO{
	/**
	 * 
	 */
	...
	public String getIatExecDate() {
		return iatExecDate;
	}
	public void setIatExecDate(String iatExecDate) {
		this.iatExecDate = iatExecDate;
	}
