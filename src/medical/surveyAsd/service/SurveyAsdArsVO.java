...
public class SurveyAsdArsVO extends KoriginCommonVO{
	/**
	 * 
	 */
	private static final long serialVersionUID = 3832796351626186071L;
	private int rownum;
	...
	public String getArsExecDate() {
		return arsExecDate;
	}
	public void setArsExecDate(String arsExecDate) {
		this.arsExecDate = arsExecDate;
	}
