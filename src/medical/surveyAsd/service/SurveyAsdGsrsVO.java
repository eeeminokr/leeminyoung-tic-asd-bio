...
public class SurveyAsdGsrsVO extends KoriginCommonVO{
	/**
	 * 
	 */
	...
	public String getGsrsExecDate() {
		return gsrsExecDate;
	}
	public void setGsrsExecDate(String gsrsExecDate) {
		this.gsrsExecDate = gsrsExecDate;
	}
