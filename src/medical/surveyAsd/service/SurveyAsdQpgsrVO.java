...
public class SurveyAsdQpgsrVO extends KoriginCommonVO{
	/**
	 * 
	 */
	...
	public String getQpgsrExecDate() {
		return qpgsrExecDate;
	}
	public void setQpgsrExecDate(String qpgsrExecDate) {
		this.qpgsrExecDate = qpgsrExecDate;
	}
