...
public class SurveyKcbclWriterMapper implements CellWriterMapper<SurveyKcbclVO>{
	@Override
	public void mapHeader(Row row, SurveyKcbclVO vo) {
		Cell cell = null;
		int i = 0;
		...
		if(rowNum==1) {
			...
			cell = row.createCell(i++);
			cell.setCellValue("56a");
			cell = row.createCell(i++);
			cell.setCellValue("56b");
			cell = row.createCell(i++);
			cell.setCellValue("56c");
			cell = row.createCell(i++);
			cell.setCellValue("56d");
			cell = row.createCell(i++);
			cell.setCellValue("56e");
			cell = row.createCell(i++);
			cell.setCellValue("56f");
			cell = row.createCell(i++);
			cell.setCellValue("56g");
			cell = row.createCell(i++);
			cell.setCellValue("56h");
			cell = row.createCell(i++);
			...
			cell = row.createCell(i++);
			cell.setCellValue("113-1");
			cell = row.createCell(i++);
			cell.setCellValue("113-2");
			cell = row.createCell(i++);
...
//			cell.setCellValue("116");
	...
	@Override
	public void mapRow(Row row, SurveyKcbclVO vo) {
		Cell cell = null;
		int i = 0;
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getKcbclExecDate());
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getA56a());
		
		cell = row.createCell(i++);
		cell.setCellValue(vo.getA56b());
		
		cell = row.createCell(i++);
		cell.setCellValue(vo.getA56c());
		
		cell = row.createCell(i++);
		cell.setCellValue(vo.getA56d());
		
		cell = row.createCell(i++);
		cell.setCellValue(vo.getA56e());
		
		cell = row.createCell(i++);
		cell.setCellValue(vo.getA56f());
		
		cell = row.createCell(i++);
		cell.setCellValue(vo.getA56g());
		
		cell = row.createCell(i++);
		cell.setCellValue(vo.getA56h());
...
//		cell.setCellValue(vo.getA116());
	...
	public void cellMerge(Sheet sheet) {
		...
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 6, 127));
		sheet.addMergedRegion(new CellRangeAddress(0, 0, 128, 140));
