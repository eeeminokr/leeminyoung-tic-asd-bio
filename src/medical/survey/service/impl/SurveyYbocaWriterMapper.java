...
public class SurveyYbocaWriterMapper implements CellWriterMapper<SurveyYbocaVO>{
	@Override
	public void mapHeader(Row row, SurveyYbocaVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyYbocaVO vo) {
		Cell cell = null;
		int i = 0;
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getYbocaExecDate());
