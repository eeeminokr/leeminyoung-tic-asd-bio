...
public class SurveyStaitParentsWriterMapper implements CellWriterMapper<SurveyStaitParentsVO>{
	@Override
	public void mapHeader(Row row, SurveyStaitParentsVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyStaitParentsVO vo) {
		Cell cell = null;
		int i = 0;
