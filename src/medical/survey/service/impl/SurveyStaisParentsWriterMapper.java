...
public class SurveyStaisParentsWriterMapper implements CellWriterMapper<SurveyStaisParentsVO>{
	@Override
	public void mapHeader(Row row, SurveyStaisParentsVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyStaisParentsVO vo) {
		Cell cell = null;
		int i = 0;
