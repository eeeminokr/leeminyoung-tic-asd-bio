...
public class SurveyKaadhdsWriterMapper implements CellWriterMapper<SurveyKaadhdsVO>{
	@Override
	public void mapHeader(Row row, SurveyKaadhdsVO vo) {
		Cell cell = null;
		int i = 0;
	...
	@Override
	public void mapRow(Row row, SurveyKaadhdsVO vo) {
		Cell cell = null;
		int i = 0;
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getKaadhdsExecDate());
		...
		cell = row.createCell(i++);
		cell.setCellValue(vo.getCarelessness());
		
		cell = row.createCell(i++);
		cell.setCellValue(vo.getHyperactivity());
