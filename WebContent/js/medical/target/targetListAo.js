 ...
 Ext.create("Ext.panel.Panel", {
		...
		items : [ {
			...
			columns : [{
				...
				text : '인체유래물 연구 동의서',
				tooltip : '인체유래물 연구 동의서',
				menuDisabled : true,
				columns : [ {
					dataIndex : 'agreeRhbmF',
					header : '부',
					tooltip : '부',
					width : 80,
					// width : 180,
...
//		val = val.replace(/ /gi, "");
	...
	var development = document.getElementsByName("development")[0].checked;
	var urine = document.getElementsByName("urine")[0].checked;
	var feces = document.getElementsByName("feces")[0].checked;
	...
	var agreeRp = document.getElementsByName("agreeRp")[0].checked;
	var agreeRhbm = document.getElementsByName("agreeRhbm")[0].checked;
	searchParams = {
		targetId : document.getElementById("targetId").value,
		targetDisId : document.getElementById("targetDisId").value,
		...
		development : development ? 'Y' : 'N',
		urine : urine ? 'Y' : 'N',	
	    feces : feces ? 'Y' : 'N',	
		agreeRp : agreeRp ? 'Y' : 'N',
		agreeRhbm : agreeRhbm ?	'Y' : 'N',	
...
function uploadExcelDownload() {
	...
	location.href = GLOBAL_CONTEXT_PATH + '/downFile.view?dir=file.sample.dir&fileName=AsdTargetUpload.xlsx';
