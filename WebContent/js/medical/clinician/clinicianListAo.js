...
function uploadExcelDownload() {
	...
	location.href = GLOBAL_CONTEXT_PATH + '/downFile.view?dir=file.sample.dir&fileName=AsdClinicianUpload.xlsx';
}
...
function gridChg(title,pageNum,rNum){
	...
	if(title == "K-SADS-PL"){
		...
		searchParams.docClassDtl = 'DC004';
		searchParams.disClassDtl = menuDisClassDtl;
