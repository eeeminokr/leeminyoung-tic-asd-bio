...
<!-- <script type="text/javascript" src="${contextPath}/js/dashboardChart2.js"></script>  -->
<script src="https://cdn.amcharts.com/lib/5/index.js"></script>
<script src="https://cdn.amcharts.com/lib/5/xy.js"></script>
<script src="https://cdn.amcharts.com/lib/5/themes/Animated.js"></script>
<script type="text/javascript"
	src="${contextPath}/js/dashboardBarChartAsd.js"></script>

<script type="text/javascript"
	src="${contextPath}/js/dashboardLineChartAsd.js"></script>
<script type="text/javascript"
	src="${contextPath}/js/dashboardChartAsd2.js"></script>
<style>
.chart--container {
	/* 	  height: 400px;
	  position: relative;
