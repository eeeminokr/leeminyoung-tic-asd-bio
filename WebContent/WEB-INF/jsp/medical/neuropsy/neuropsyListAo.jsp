...
<script type="text/javascript" src="${contextPath}/js/medical/neuropsy/neuropsyListAo.js"></script>
<style>
	.pep-header>div:nth-of-type(1) {
        height: 50px;
        display: table-cell;
        padding-left: 10px;
...
<body>	
	<div id="BodyDiv">
		<div class="content_head">
			<h2 class="tit" style="padding-right: 20px;">심리 /발달검사</h2>
            <h3 class="tit"></h3>
            <div class="submenu">
            </div>
			<!-- <div id="menuDiv" class="submenu"></div> -->
			<div class="btns">
				<eco:authorize menuId="AO03" authName = "deleteYn">
				...
				<eco:authorize menuId="AO03" authName = "uploadYn">
				...
				<eco:authorize menuId="AO03" authName = "downYn">
				<div class = "dropdown">
            	...
            	<form id="searchForm">
	                ...
	                <ul>
	                    ...
	                    <li>
	                        ...
	                        <div class="cont">
	                            <input type="text" id="targetDisId" style="width:123px;" />
	                        </div>
	                    </li>
	                    <li>
	                    ...
	                    <li class="total_search">
	                        <div class="check_right">
								<label><input type="checkbox" name="s1" /><span>지능검사</span></label>	                        
	                            <label><input type="checkbox" name="ata" /><span>ATA</span></label>
	                            <label><input type="checkbox" name="stroop" /><span>STROOP</span></label>
	                            <label><input type="checkbox" name="cctt" /><span>CCTT</span></label>
	                            <label><input type="checkbox" name="wsct" /><span>WCST</span></label>
	                            <label><input type="checkbox" name="cat" /><span>CAT</span></label>
	                            <label><input type="checkbox" name="exitii" /><span>EXIT-II</span></label>
								<label><input type="checkbox" name="cpt3" /><span>CPT-3</span></label>
								<label><input type="checkbox" name="tmt" /><span>TMT</span></label>
	              				<label><input type="checkbox" name="ados1" /><span>ADOS</span></label>
	                            <label><input type="checkbox" name="ados2" /><span>ADOS-2</span></label>
	                            <label><input type="checkbox" name="pep" /><span>PEP-R</span></label>
	                            <label><input type="checkbox" name="sms" /><span>SMS</span></label>
								<label><input type="checkbox" name="cars" /><span>CARS</span></label>
