...
<script type="text/javascript" src="${contextPath}/js/medical/target/targetListAo.js"></script>
<style>
	/* 해당 페이지만 폰트 사이즈 업 */
...
<body>	
	<div id="BodyDiv" style> 
		<div class="content_head">
            ...
            <div class="btns">
            	<eco:authorize menuId="AO01" authName = "deleteYn">
                ...
                <eco:authorize menuId="AO01" authName = "uploadYn">
                <button type="button" onclick="excelUpload();" class="btnsStyle"><img src="${contextPath}/images/img/ico_upload.png" alt="" /><span>업로드</span></button>
               	...
               	<eco:authorize menuId="AO01" authName = "downYn">
               	<div class = "dropdown">
	                ...
	                <ul>
	                    ...
	                    <li>
	                        <div class="check_right">
	                            ...
	                            <label><input type="checkbox" name="development" /><span>발달</span></label>
	                            <label><input type="checkbox" name="urine" /><span>채뇨</span></label>
	                            <label><input type="checkbox" name="feces" /><span>채변</span></label>
	                            <label><input type="checkbox" name="agreeRp" /><span>연구참여동의서</span></label>
	                             <label><input type="checkbox" name="agreeRhbm" /><span>인체유래물연구동의서</span></label>
